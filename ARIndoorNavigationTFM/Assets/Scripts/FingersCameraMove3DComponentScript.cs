    ...
    public class FingersCameraMove3DComponentScript : MonoBehaviour
    {
        ...
        private void PanGestureCallback(GestureRecognizer gesture)
        {
            if (gesture.State == GestureRecognizerState.Executing)
            {
                ...
                moveVelocity += (q * Vector3.right * DeviceInfo.PixelsToUnits(gesture.DeltaX) * Time.deltaTime * PanSpeed * 50.0f);
                moveVelocity += (q * Vector3.forward * DeviceInfo.PixelsToUnits(gesture.DeltaY) * Time.deltaTime * PanSpeed * 50.0f);
            }
        }
        ...
        {
            Debug.Log("Desactivamos: El Figerrrrrr");
